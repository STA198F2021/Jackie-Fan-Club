...
We ran a multiple logistic regression for health insurance access and health provider access conditional on gender, race, and sexuality. 
.footnote[
...
- The most negatively affected identity group in regards to whether or not someone has access to a regular healthcare provider or not, we found that the most negatively affected identity group was transgender, followed by Hispanic, and followed by black individuals. 

- For example, our referent group of white, cis, heterosexual individuals are 1.46 times more likely to have health insurance than non-white, trans, non-heterosexual counterparts.

- They are also 1.32 times more likely to have access to a regular healthcare provider than marginalized identities. 
