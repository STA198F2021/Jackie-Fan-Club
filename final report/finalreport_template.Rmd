...
According to the step-down ANOVA, Two-Spirit and Queer sexuality groups have statistically significant different self-reported health outcome score from the rest of the sexuality groups. T-tests were conducted in order to determine how Two-Spirit and Queer groups differ in comparison to Straight groups in self-reported healthcare outcomes. 
