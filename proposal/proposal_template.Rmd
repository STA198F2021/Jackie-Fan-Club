...
ADDED CONTENT: This data visualization section was added in response to our proposal feedback. We were docked points for not including data visualization which is now added here. Included below is a preliminary data visualization illustrating the types of data that we was collected. This is a series of boxplots, divided by personal assessment of health. Each boxplot summarizes the spread of approximate age. In this case, the general similarities between these groups means this dataset doesn't show evidence of discrimination of health outcomes by age. Our later analyses will look into unequal access to medical care where groups show differing health outcomes. This plot also include a plot for the missing data which skews slightly more to older respondents. This is a factor to consider when doing any sort of data analysis or drawing conclusions.
