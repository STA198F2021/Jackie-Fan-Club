...
```{r}
# data_test <- data %>%
#   filter(sexuality %in% c("(08) Straight/Heterosexual", "(04) Two Spirit", "(05) Queer")) 
# data_test%>%
#   mutate(
#     Straight = case_when(
#     sexuality == "(08) Straight/Heterosexual" ~ "TRUE",
#     is.na(data_test$Straight) ~ "FALSE"),
#     Queer = case_when(
#       sexuality == "(05) Queer" ~ "TRUE",
#       is.na(data_test$Queer) ~ "FALSE"),
#     TwoSpirit = case_when(
#       sexuality == "(04) Two Spirit" ~ "TRUE",
#       is.na(data_test$TwoSpirit) ~ "FALSE"
#     )
#   )
# 
